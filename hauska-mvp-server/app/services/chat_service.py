...
class ChatService:
    ...
    def process_and_save_message(self, user_id: str, query_message: str, delta_id="", image_base64=None) -> str:
    ...
    def get_chat_by_message_id(self, message_id: str):
        ...
        return self.chat_repository.get_chat_by_message_id(message_id)
