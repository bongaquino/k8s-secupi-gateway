...
def load_container():
    ...
    from app.providers.delta_provider import DeltaProvider
    ...
    container.register("providers.delta_provider", delta_provider)

    # Import repositories
    from app.repositories.user_repository import UserRepository
    from app.repositories.profile_repository import ProfileRepository
    from app.repositories.chat_repository import ChatRepository
    from app.repositories.delta_repository import DeltaRepository
    ...
    delta_repository = DeltaRepository(mongo_provider)
    ...
    container.register("repositories.delta_repository", delta_repository)
    ...
    delta_service = DeltaService(delta_provider, delta_repository)
    ...
    container.register("services.delta_service", delta_service)
